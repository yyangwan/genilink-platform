...
### Fixed
- Unsubscribed workspaces can reach the subscription guidance flow reliably after container signing-key permissions are normalized and validated during deployment.
