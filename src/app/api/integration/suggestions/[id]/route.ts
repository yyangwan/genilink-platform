...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Failed to fetch suggestion' }, { status: 502 });
  }
}
...
export async function PATCH(
  ...
  try {
    ...
    return NextResponse.json({ error: `Failed to update suggestion: ${(err as Error).message}` }, { status: 502 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Failed to delete suggestion' }, { status: 502 });
  }
}
