...
/**
 * POST /api/integration/audits/[id]/report
 * Generate a report from a completed audit (proxies to 智見).
 */
export async function POST(
  ...
  try {
    ...
    return NextResponse.json({ error: `Failed to generate report: ${(err as Error).message}` }, { status: 502 });
  }
}
